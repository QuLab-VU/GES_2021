...
df_DS1 = pd.read_pickle('PC9-DS1_param-scan_expandedRange.pkl')
df_DS3 = pd.read_pickle('PC9-DS3_param-scan_expandedRange.pkl')
df_DS4 = pd.read_pickle('PC9-DS4_param-scan_expandedRange.pkl')
df_DS6 = pd.read_pickle('PC9-DS6_param-scan_expandedRange.pkl')
df_DS7 = pd.read_pickle('PC9-DS7_param-scan_expandedRange.pkl')
df_DS9 = pd.read_pickle('PC9-DS9_param-scan_expandedRange.pkl')
...
all_dfs = [df_DS1, df_DS3, df_DS4, df_DS6, df_DS7, df_DS9]
...
df_all.to_csv('all_cellLine_tile_ER.csv')